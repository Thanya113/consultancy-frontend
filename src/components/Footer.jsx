    ...
    <footer style={{ backgroundColor: '#f2f2f2', color: '#333' }}>
      <Container>
        ...
        <Row className='justify-content-center'>
          ...
          <Col md={4} className='text-center py-3'>
            <div style={{ marginBottom: '10px' }}>
              ✉️ <b><a href="mailto:info@example.com" style={{ color: '#333', textDecoration: 'none',fontStyle:"italic" }}>Mail Us</a></b>
          ...
          <Col md={4} className='text-center py-3'>
            <div style={{ marginBottom: '0px' }}>
              ☎️ <b><span style={{ color: '#333',fontStyle:"italic" }}>Call Us</span></b>
